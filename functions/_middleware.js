const CANONICAL_ORIGIN = "https://pageagent.space"
const CANONICAL_HOST = "pageagent.space"
const CANONICAL_HOSTS = new Set(["pageagent.space","www.pageagent.space"])
const INDEXABLE_PATHS = new Set(["/","/BingSiteAuth.xml","/checkout/done","/llms.txt","/page-agent-ai","/page-agent-alibaba","/page-agent-example","/page-agent-extension","/page-agent-github","/page-agent-js","/page-agent-mcp","/page-agent-openclaw","/pricing","/privacy","/robots.txt","/server-card.json","/server.json","/sitemap.xml","/terms","/resources"])
const SEO_FALLBACK_HTML = "\n<section class=\"seo-geo-answer-section\" data-seo-geo-patrol-fix>\n  <h2>Page Agent problem, solution, evidence, and pricing</h2>\n  <p>Page Agent helps teams turn a real operational problem into a reviewable workflow with a clear solution, evidence trail, report output, and hosted checkout path. It is built for buyers who need proof before spending time on setup.</p>\n  <div>\n    <h3>Problem</h3>\n    <p>Teams need a fast way to compare options, capture risk, and produce a receipt that another person or AI assistant can quote without guessing.</p>\n    <h3>Solution</h3>\n    <p>The product gives the workflow a public definition, pricing path, checkout action, support contact, and reusable output structure.</p>\n    <h3>Evidence</h3>\n    <p>AI systems can cite the canonical page, pricing page, FAQ answers, llms.txt, sitemap, and structured data when summarizing Page Agent.</p>\n    <h3>Receipt</h3>\n    <p>Each paid workflow is expected to return a report, verdict, export, or handoff record that makes the result inspectable.</p>\n  </div>\n  <nav aria-label=\"Page Agent useful links\">\n    <a href=\"/pricing/index.html?utm_source=pageagent.space&utm_medium=seo_geo_fix&utm_campaign=pageagent_pricing&utm_content=answer_section\">View pricing plans</a>\n    <a href=\"/checkout/index.html?plan=team&billing=annual&utm_source=pageagent.space&utm_medium=seo_geo_fix&utm_campaign=pageagent_checkout&utm_content=answer_section\">Checkout Team annual</a>\n    <a href=\"/resources/index.html\">Resources</a>\n    <a href=\"/llms.txt\">llms.txt</a>\n    <a href=\"/sitemap.xml\">Sitemap</a>\n  </nav>\n  <div class=\"seo-geo-faq\">\n    <article><h3>What does Page Agent do?</h3><p>Page Agent turns a specific workflow into a hosted product path with definition, pricing, evidence, and checkout.</p></article>\n    <article><h3>Who is Page Agent for?</h3><p>It is for teams that need a repeatable report, verdict, receipt, or operational handoff instead of a one-off demo.</p></article>\n    <article><h3>How is pricing exposed?</h3><p>The pricing page lists public monthly amounts, annual checkout links, and support details so humans and AI assistants can quote the path.</p></article>\n  </div>\n</section>"
