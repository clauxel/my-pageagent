...
const origin = 'https://pageagent.space'
...
await writeStaticPage('/pricing', {
  title: 'PageAgent Space Pricing | Pro Annual Page Agent Launch',
  description: 'Compare PageAgent Space Starter, Pro, and Scale plans. Pro annual is selected by default and annual billing is 50% cheaper.',
  robots: 'index,follow',
...
await writeStaticPage('/privacy', {
  ...
  description: 'How PageAgent Space handles analytics, checkout metadata, and managed-site interactions.',
  robots: 'index,follow',
  canonicalPath: '/privacy',
  rootHtml: buildLegalPrerender('Privacy Policy', 'This policy covers analytics, checkout, and user interactions on the PageAgent Space site.', [
    {
      heading: 'What we collect',
      paragraphs: [
        'PageAgent Space collects only the information reasonably needed to operate the website, process checkout, prevent abuse, and respond to support.',
        'The public fit console does not require credentials, secrets, source code, production data, customer records, or regulated information.',
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        'No internet service can be guaranteed perfectly secure. Users should not submit credentials, secrets, regulated data, or highly sensitive information through the public fit console.',
...
await writeStaticPage('/terms', {
  ...
  description: 'Terms for using PageAgent Space, hosted payment flow, launch planning, and related support services.',
  robots: 'index,follow',
  canonicalPath: '/terms',
  rootHtml: buildLegalPrerender('Terms of Service', 'These terms describe the limits and responsibilities of the PageAgent Space site.', [
    {
      heading: 'Acceptance and review required',
      paragraphs: [
        'PageAgent Space is provided for supervised Page Agent launch planning. AI-assisted and browser-action output may be incomplete, inaccurate, insecure, infringing, unsuitable, delayed, unavailable, or wrong.',
    ...
    },
    {
      ...
      paragraphs: [
        'PageAgent Space is provided as is and as available. To the maximum extent permitted by law, all express, implied, statutory, and other warranties are disclaimed.',
        'We do not warrant uninterrupted service, error-free operation, complete security, accuracy of AI output, revenue results, rankings, conversion results, checkout availability, browser compatibility, or business outcomes.',
      ],
    },
    {
      ...
      paragraphs: [
        ...
        'To the maximum extent permitted by law, total liability for any claim is limited to the greater of 100 USD or the amount paid for PageAgent Space in the three months before the event giving rise to the claim.',
      ],
    },
    {
      heading: 'Disputes',
...
await writeStaticPage('/checkout/done', {
  ...
  rootHtml: buildLegalPrerender('Finishing checkout...', 'You will return to the PageAgent Space homepage when the hosted payment session closes.'),
  structuredData: [],
})
...
function renderHtml({ title, description, robots, canonicalPath, rootHtml, structuredData }) {
  ...
  if (graph) {
    html = html.replace(
      '</head>',
      `    <script type="application/ld+json" id="pageagent-prerender-schema">${JSON.stringify(graph)}</script>\n  </head>`,
    )
  }
  ...
  return `
    <main class="df-main">
      <section class="df-pricing-page-hero">
        ...
        <p class="df-lede">Pro annual is the default path and annual billing is 50% cheaper than the monthly run-rate.</p>
      </section>
    </main>`
}
